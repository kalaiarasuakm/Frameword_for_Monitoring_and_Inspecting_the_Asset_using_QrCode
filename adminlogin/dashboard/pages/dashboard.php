...
require_once('issue_asset.php');
require_once('condemned_asset.php');
require_once('sold_asset.php');
require_once('stolen_asset.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-4 fixed-left ms-4" id="sidenav-main">
  
    <img src="login.png" alt="regenboog india" width="180" height="150" class="logo">
      ...
      <ul class="navbar-nav">
        <li class="nav-item mb-1">
          <a class="nav-link  active" href="../pages/dashboard.html">
            <div class="icon icon-shape icon-xs shadow border-radius-sm bg-gradient-light text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mb-1">
          <a class="nav-link  " href="multicell-table.php">
            <div class="icon icon-shape icon-xs shadow border-radius-sm bg-gradient-light text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>Asset Tables</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Newly Asset Table</span>
          </a>
        </li>
		<li class="nav-item mb-1">
          <a class="nav-link  " href="update_fpdf.php">
            <div class="icon icon-shape icon-xs shadow border-radius-sm bg-gradient-light text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Updated Asset Table</span>
          </a>
        </li>
        <li class="nav-item mb-1">
          <a class="nav-link  " >
  ...
  <main class="main-content mt-4 border-radius-lg">
    <!-- Navbar -->
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid px-3">
        <nav aria-label="breadcrumb"><br>
          <h1 class="font-weight-normal">REGENBOOG INDIA FOUNDATION</h1>
        </nav>
		  <img src="logo.png" class="response" alt="aec" width="150" height="100">
          </div>
        </div>
      </div>
    </nav>   
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-7">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Overall Assets</p>
                    <h5 class="font-weight-bolder"><?php echo $_SESSION['rows_count_value']; ?></h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-7">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Issued assets</p>
                    <h5 class="font-weight-bolder"><?php echo $_SESSION['use_asset']; ?><h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-7">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Condemned Assets</p>
                    <h5 class="font-weight-bolder"><?php echo $_SESSION['condemned_asset']; ?></h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-7">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Sold Assets</p>
                    <h5 class="font-weight-bolder"><?php echo $_SESSION['sold_asset'];?></h5>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-7">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Stolen Assets</p>
                    <h5 class="font-weight-bolder"><?php echo $_SESSION['stolen_asset']; ?></h5>
...
$sql = "SELECT asset, scanning_time, scanning_date FROM persons ORDER BY scanning_date DESC LIMIT 5";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table>";
            echo "<tr>";
                echo "<th>Asset</th>";
                echo "<th>Scanning Time</th>";
                echo "<th>Scanning Date</th>";
                
            echo "</tr>";
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                echo "<td>" . $row['asset'] . "</td>";
                echo "<td>" . $row['scanning_date'] . "</td>";
                echo "<td>" . $row['scanning_time'] . "</td>";
...
// Attempt select query execution
$sql = "SELECT asset, update_scanning_time, update_scanning_date FROM persons ORDER BY update_scanning_date DESC LIMIT 5";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        echo "<table class='update'>";
            echo "<tr>";
                echo "<th>Asset</th>";
                echo "<th>Update Scanning Date</th>";
                echo "<th>Update Scanning Time</th>";
                
            echo "</tr>";
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                echo "<td>" . $row['asset'] . "</td>";
                echo "<td>" . $row['update_scanning_date'] . "</td>";
                echo "<td>" . $row['update_scanning_time'] . "</td>";
