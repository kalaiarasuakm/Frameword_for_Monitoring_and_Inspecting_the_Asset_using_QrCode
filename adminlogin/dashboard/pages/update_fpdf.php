...
$pdf->SetFont('Times','I',30);
$pdf->SetTextColor(0,191,255);
$pdf->Cell(400,30,'Updated Asset Details',0,0,'C');
$pdf->Ln();
//set width for each column 
$pdf->SetWidths(Array(10,20,25,20,25,30,30,20,30,15,30,20,25,25,25,26,26));
$width_cell=array(10,20,25,20,25,30,30,20,30,15,30,20,25,25,25,26,26);
//set line height
$pdf->SetLineHeight(5);
...
$pdf->Cell($width_cell[15],5,'UTOS',1,0,'C'); 
$pdf->Cell($width_cell[16],5,'UDOS',1,0,'C');
$pdf->Ln(5);
...
foreach($result as $item){
	...
	$item['asset_status'],
	$item['remarks'],
	$item['update_scanning_time'],
	$item['update_scanning_date'],
	));
}
